...
def run():
    ...
    st.markdown(
        ...
        /* Streamlitテーマ対応 */
        .stApp[data-theme="dark"] [data-testid="stDataFrame"] td:first-child,
        .stApp[data-theme="dark"] [data-testid="stDataFrame"] th:first-child {
            color: #cccccc !important;
            background-color: #343a40 !important;
        }
        
        .stApp[data-theme="light"] [data-testid="stDataFrame"] td:first-child,
        .stApp[data-theme="light"] [data-testid="stDataFrame"] th:first-child {
    ...
    # プレイヤー列の文字色を明示的に設定
    styled_matrix = styled_matrix.set_properties(subset=['Player'], **{
        'color': '#495057',
    ...
    # プレイヤー列の文字色を明示的に設定
    styled_results = styled_results.set_properties(subset=['Player'], **{
        'color': '#495057', 
        'background-color': '#f8f9fa', 
        'font-weight': 'bold'
    })
